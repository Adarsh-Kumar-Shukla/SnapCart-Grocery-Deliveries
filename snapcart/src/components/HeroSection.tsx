  ...
  const slides=[
    {
      ...
      btnText:"Shop Now",
      bg:"https://media.istockphoto.com/id/1128687123/photo/shopping-bag-full-of-fresh-vegetables-and-fruits.jpg?s=1024x1024&w=is&k=20&c=ZP6MR_8ca51_wrOQFjp5HN0cK1TwmMHMc8sRZy9Dxn4="
    },
    {
      id:2,
      ...
      btnText:"Order Now",
      bg:"https://plus.unsplash.com/premium_photo-1665203442280-1118daf3de38?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
    },
    {
      id:3,
  ...
  return (
    <div  className='relative w-[98%] mx-auto mt-32 h-[80vh] rounded-3xl overflow-hidden shadow-2xl'>
      <AnimatePresence mode='wait' >
        ...
        >
          <Image src={slides[current].bg} alt='slide1' fill priority className='object-cover' />
      ...
      <div className='absolute inset-0 flex items-center justify-center text-center text-white px-6' >
        ...
        >
          ...
          className='mt-4 bg-white hover:bg-green-700 text-green-700 hover:text-green-100 px-8 py-3 rounded-full font-semibold shadow-lg transition-all duration-300 flex items-center gap-2' >
