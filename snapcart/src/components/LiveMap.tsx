...
const LiveMap = ({ userLocation, deliveryBoyLocation }: IProps) => {
  ...
  const linesPositions = 
    ...
    [[userLocation.latitude, userLocation.longitude], [deliveryBoyLocation.latitude, deliveryBoyLocation.longitude]] : []
  ...
  return (
    <div className="w-full h-[500px] rounded-xl overflow-hidden shadow relative z-2">
      ...
      >
        ...
        <Polyline positions={linesPositions as any} color="green" />
      </MapContainer>
    </div>
  );
};
