...
const CategorySlider = () => {
  const categories = [
    ...
    { id: 6, name: "Baverages & Drinks", icon: Coffee, color: "bg-blue-100" },
    ...
    { id: 10, name: "Baby & Pet Care", icon: Apple, Baby, color:"bg-rose-100" },
  ];
        ...
        {categories.map((cat,index)=>{
          ...
          >
            <div className="flex flex-col items-center justify-center p-5">
              ...
              <p className="text-centertext-sm md:text-base font-semibold text-gray-700">{cat.name}</p>
            </div>
          </motion.div>
        })}
      </div>
