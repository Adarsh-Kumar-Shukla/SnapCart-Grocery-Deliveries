    ...
    <div className="w-[92%] md:w-[80%] mx-auto py-10 relative">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <motion.div
          ...
          transition={{ duration: 0.3 }}
          className="bg-white rounded-2xl shadow-lg hover:shadow transition-all duration-300 p-6 border border-gray-100"
        >
          ...
          <div className="space-y-4">
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 w-full border rounded-lg p-3 text-sm bg-gray-50 capitalize"
              />
            </div>
            <div className="relative">
              <Phone
            ...
            <div className="relative mt-6 h-[330px] rounded-xl overflow-hidden border border-gray-200 shadow-inner">
              ...
              <motion.button
                whileTap={{ scale: 0.93 }}
                className="absolute bottom-4 bg-green-600 text-white shadow-lg rounded-full p-3 hover:bg-green-700 transition-all flex items-center justify-center z-[999] cursor-pointer"
        ...
        >
          ...
          <div className="border-t pt-4 text-gray-700 space-y-2 text-sm sm:text-base">
            ...
            <div className="flex justify-between">
              <span className="font-semibold">Delivey Fee:</span>
